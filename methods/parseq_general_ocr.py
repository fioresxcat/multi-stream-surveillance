...
class ParseqGeneralOCR(BaseOCR):
    instance = None
    ...
    def get_instance(common_config, model_config):
        if ParseqGeneralOCR.instance is None:
            ParseqGeneralOCR.instance = ParseqGeneralOCR(common_config, model_config)
        return ParseqGeneralOCR.instance
